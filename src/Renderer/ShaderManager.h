    ...
    */
    ...
    public:
        ...
        * \code
                ...
                glDeleteShader(fragmentShaderId); // Фрагментного шейдера это тоже касается. Удаляем.
        * \endcode
        */
        ...
        */
        ...
        /*!
        * Запрещаем копирование менеджера шейдера в другой менеджер, так как у нас получатся два объекта с одним и тем же id и когда программа будет удаляться, возникнет непредвиденный момент.
        */
        ShaderManager(const ShaderManager&) = delete;
        /*!
        * Запрещаем присваивание менеджера шейдера в другой менеджер, так как у нас получатся два объекта с одним и тем же id и когда программа будет удаляться, возникнет непредвиденный момент.
        */
