...
namespace RenderEngine {
    /*!
    *  \brief Зачастую в играх разработчики хотят придавать объектам разные формы, а не только треугольные. Однако OpenGl уммет отрисовывать только треугольники, линии и точки.
    Поэтому нужно, отрисовать так много треугольников, чтобы из них получилось что-то не треугольное. Например, чтобы вывести на экран квадрат достаточно нарисовать два треугольника. 
    Но чем больше треугольников мы рисуем, тем больше вершин нам придётся передавать в буферный объект, а следовательно, в память.
    ...
    */
    ...
    public:
        ...
        */
        ...
        /*!
        * Запрещаем копирование класса в другой класс, так как у нас получатся два объекта с одним и тем же id и когда программа будет удаляться, возникнет непредвиденный момент.
        */
